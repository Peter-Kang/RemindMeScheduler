...
import "./Assets/css/EditReminders.css";
    ...
    <Container>
      ...
      <Row className="d-flex align-items-center">
        <Col md={12} className="d-flex justify-content-end">
          <Link variant="success" to="/" className="btn btn-outline-success">
            View
          </Link>
        </Col>
      </Row>
      ...
      <br />
      <EditReminderRowEditInputForm
        arrayOfReminderInstances={todos}
